...
/// <summary>Represents the operation of down-casting a <see cref="IEntityQueryModel{TSource,TResult}"/>.</summary>
    ...
    where TSource : class, TResult
{
    ...
    public QueryModelDownCasting(IEntityQueryModel<TSource, TResult> queryModel) => _queryModel = queryModel;
    ...
    public IEntityQueryModel<TSource> Create() =>
        new DerivedEntityQueryModel<TResult, TSource>(_queryModel);
    ...
    public IEntityQueryModel<TDerived> To<TDerived>()
        where TDerived : class, TSource =>
        new DerivedEntityQueryModel<TResult, TDerived>(_queryModel);
}
